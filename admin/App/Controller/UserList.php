<?php
    ...
    */
    public function __construct()
    {
      ...
      $this->form->addAction('Novo', new Action(array(new UserForm, 'onEdit')));
      ...
      $name     = new DatagridColumn('name',  'Nome', 'left', null);
      
      // adiciona as colunas à Datagrid
      $this->datagrid->addColumn($codigo);
      $this->datagrid->addColumn($name);
      
      $this->datagrid->addAction( 'Editar',  new Action([new UserForm, 'onEdit']), 'id', 'fa fa-edit fa-lg blue');
    ...
    */
    public function onReload($param)
    {
      ...
      {
        // filtra pelo name
        $criteria->add('name', 'like', "%{$dados->name}%");
      }
    ...
    */
    public function Delete($param)
    {
      try
      {
        ...
        $cidade = new User($key); // instancia objeto Cidade
